...
Public documentation must not include credentials, personal identifiers,
provider session stores, raw agent transcripts, or private runtime data.
Source components remain independent; this directory is not a source archive.
